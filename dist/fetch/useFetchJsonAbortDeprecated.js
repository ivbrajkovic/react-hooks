...
var useFetchJsonAbort = function (url, options) {
    ...
    var abortControllerRef = react_1.useRef();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.fetchJsonAsync(url, __assign(__assign({}, options), { signal: signal }))];
                    case 1:
                        data = _a.sent();
                    ...
                    case 2:
                        error_1 = _a.sent();
                        dispatch({ type: TYPES.SET_ERROR, payload: error_1.message });
                        return [3 /*break*/, 3];
